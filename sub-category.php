...
<head>
    ...
    <meta property="og:image" content="categoryImage/<?echo $get_sub_row['subcategory_image']?>" />
    <meta property="og:title" content="<?=$subCatName?>" />
    <meta property="og:description" content="<?echo $get_sub_row['sub_soc_description']?>" />
    <meta name="description" content="<?echo $get_sub_row['sub_soc_description']?>">

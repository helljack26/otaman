...
<head>
    ...
    <title>Список бажань | Отаман</title>
            ...
            <div class="product_category_row_results">
                <? if($num>0){
                    while ($rowWish=mysqli_fetch_array($get_wish)) :
                        ...
                        $ret=mysqli_query($conVikar,"SELECT * from products where organization='ТД ОТАМАН' and c_code='$pid' and characteristic_uuid='$characteristic_uuid'");

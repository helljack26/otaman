...
<div class="discount_container wow fadeInUp">
    ...
    <div id="similar_slider" class="discount_slider">
        <?php
            $promo = $dbh->prepare('SELECT * from products  where sub_сategory= ? and category=? and product_price > 1 GROUP BY product_work_name LIMIT 10');
            ...
            while ($row2 = $promo->fetch(PDO::FETCH_LAZY)): 	
                ...
                $c_characteristic_uuid = $row2['characteristic_uuid'];

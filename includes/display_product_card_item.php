    ...
    <div class="product_category_row_results_item_content ">
        <div class="<?php if($row['product_availability'] < 1 && $row['product_count'] < 1){
                ...
                <a href="<?= $productLink;?>">
                    <img src="<?
                        if($row['productImage1']=='') {
                            ...
                            echo 'images/'. htmlentities($row['productImage1']);
                            }
                        ?>" height="210px" alt="<?=replaceDoubleQuote($row['product_name'])?>">
                </a>
            </div>
            <!-- Product info -->
            <div class="product_category_row_results_item_content_info">
                ...
                <!-- Product name -->
                <a class="product_category_row_results_item_content_info_name" href="<?= $productLink;?>">
        ...
        <div class="product_category_row_results_item_content_info_footer">
            ...
            <?
                ...
                }?>" data-id-wishList="<?php echo $row['c_code'];?>" data-is-login="<?echo $_SESSION['login']?>"

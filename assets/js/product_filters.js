...
$(document).ready(function () {
    ...
    let defaultSort = 'and product_price > 1 GROUP BY product_work_name ORDER BY product_availability DESC'
    ...
    const getProduct = () => {
        ...
        $.ajax({
            ...
            success: function (html) {
                $(document).find(".product_category_row_results_block").html(html);
            },
        });
    };
    ...
    const getAllCheckedCheckbox = () => {
        console.log("🚀 ~ file: product_filters.js:162 ~ curl_path:", curl_path)

...
$product = getPidFromProductNameAndChar($pid, $char, $spec);
...
$executeQuery = strlen($charHash) > 0 ? [':pid'=> $getPid, ':charHash'=>$charHash] : [':pid'=> $getPid];
   ...
   $pid = $dbh->prepare("SELECT * from products where organization='ТД ОТАМАН' $prepareQuery ORDER BY product_availability DESC");
...
<head>
    ...
    <meta property="og:image"
        content="<?if($c_photo1=='') {echo'categoryImage/no_foto.jpg'; }else{echo 'images/'. $c_photo1;}?>">

    <meta property="og:description"
        content="<?=replaceDoubleQuote($c_product_name) . ' ' . $product_spec;?>  для військових за доступними цінами ✪ Армійські товари в наявності ★ Воєнторг з доставкою у всі регіони України" />
    ...
    <title><?=$c_product_name . ' ' . $product_spec;?> - Купити в Києві | Військторг OТАМАН</title>
...
<body class="cnt-home" id="reload-wrapper">
    ...
    <main>
        ...
        <ul class="product_breadcrumb">
            ...
            <?php  if($c_product_key_det == 0){ echo '<li>' . "$c_product_name";?>
            </li>
            <? } else{  ?>
            <li>
        ...
        <div class="product_header">
            <div class="product_header_info">
                <!-- Product name -->
                <h1>
                    <?php echo($c_product_name) . ' ' . $product_spec;?>
                </h1>
                <!-- Product rating -->
        ...
        <div class="product_row">
            <div class="product_row_col">
                ...
                <div class="product_img_container">
                    ...
                    <div class="product_img_container_slider">
                        ...
                        <?} else {?>
                        <div class="product_img_container_slider_item">
                            <img src="categoryImage/no_foto.png">
                        </div>
                        <? } ?>
                        <? if($c_photo2==''){?>
                        <?}?>
            ...
            <div class='product_row_col'>
                <div class="product_info">
                    ...
                    <!-- Characteristics -->
                    <?
                  $get_chars=mysqli_query($conVikar,"SELECT characteristic_uuid, product_spec, product_availability  from products where organization='ТД ОТАМАН' and c_code='$getPid'");
               ...
               ?>
                  ...
                  ?>
                    ...
                    <form method="get" action="product-details.php">
                        <input type="hidden" type="text" name="action" value="add" />

                        <div class="product_info_price">
                            <input type="hidden" class="price" name="price" value="<?=$c_price?>">
                            <input type="hidden" name="id" value="<?=$c_code?>">
                            <?if($c_old_price >= 1):?>
                        ...
                        <div class="product_info_buttons">
                            ...
                            <button type="button" class="exampleModalLong24
                                <? if(isExistInBasket($getPid, $c_characteristic_uuid) != 'Купити') {
                                    echo('exampleModalLong24_active');
                                }?>" data-code="<? echo($getPid);?>" data-char='<?=$c_characteristic_uuid?>'>
                                <? echo(isExistInBasket($getPid,$c_characteristic_uuid));?>
                            </button>

                            <button type="button" id="product_info_fastOrder" data-product-code="<? echo($getPid);?>"
                        ...
                        <div class="tablet_display_block">
                            ...
                            <div class="product_info_social">
                                <div class="product_info_social_block">
                                    ...
                                    <?php
                            $actual_link = 'https://otaman.net'."$_SERVER[REQUEST_URI]"; 
                    ...
                    <div class="product_info_delivery">
                        ...
                        <div class="product_info_delivery_item">
                            <span class="product_info_delivery_item_title before_icon_bus">
                                Адресна доставка кур’єром "Отаман"
                            </span>
                            <span class="product_info_delivery_item_date">
                                вiдправимо <?php echo($tommorrow)?>
                            </span>
    ...
    <?php include('includes/similar_slider.php');?>

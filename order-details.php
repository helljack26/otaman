...
<head>
    ...
    <title>Деталі замовлення | Otaman.net</title>
                            ...
                            <form name="cart" method="post">
                                <table class="table table-bordered">
                                    <div class="row" style="border-left:1px solid #8ec340;">
                                        ...
                                        $ret=mysqli_query($conVikar,"SELECT * from products where organization='ТД ОТАМАН' and c_code='$order_id_h'  and characteristic_uuid='$characteristic_uuid'");

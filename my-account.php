...
<head>
    ...
    <title>Особистий кабінет | Отаман</title>
                            ...
                            <div class="panel panel-default checkout-step-01">
                                ...
                                <div id="collapseOne" class="panel-collapse collapse in">
                                    <div class="panel-body">
                                        ...
                                        ?>
                                        <div class="row">
                                            <h3 style="padding-bottom: 30px; margin-top: -10px;">
                                                Накопичені бонуси: <span style="color: #8ec340; font-weight: bold;"><?= $userBonus?></span> грн.
                                            </h3>
                                ...
                                <div id="collapseTwo" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <form class="register-form" role="form" method="post" name="chngpwd"
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Current Password">Поточний
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="New Password">Новий пароль
                                                    <span>*</span></label>
                                                <input type="password"
                                            ...
                                            <div class="form-group">
                                                <label class="info-title" for="Confirm Password">Підтвердження
                                                    пароль<span>*</span></label>
                                                <input type="password"

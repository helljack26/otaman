...
if(isset($_POST['submit'])){
    ...
    $insert_user=mysqli_query($con,"INSERT INTO `users`(`name`, `midle_name`, `last_name`, `email`, `contactno`, `password`, `osoba`) VALUES ('$firstname','$midlename','$lastname','$email','$contactno','$password','0')");

    if($insert_user) {
        $_SESSION['login']=$email;
        $_SESSION['username']=$firstname;
    } else {
        echo "<script>alert('Помилка при реєстрації, щось пішло не так...');</script>";
    }
}
// Code for User login
if(isset($_POST['login']) || $_POST['login']=='price'){
    $email=$_POST['email'];
    $password=md5($_POST['password']);
...
echo "<script>window.location = '$extra'</script>";
exit;
}}
            ...
            <div class="sign-in-page inner-bottom-sm">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 sign-in">
                        ...
                        <p class="">Привіт! Ласкаво просимо до вашого облікового запису.</p>
                        <form class="register-form outer-top-xs" method="post">
                            ...
                            <div class="radio outer-xs">
                                <a href="forgot-password.php" class="forgot-password pull-right">Забули свій пароль?</a>
                            </div>
                            <button type="submit" class="btn-upper btn btn-primary checkout-page-button"
                                name="login">Увійти</button>
                        </form>
                    </div>
                    <!-- Sign-in -->
                                ...
                                <p>
                                    <label name="reg_yes" id="check_text" style="padding-left:10px;color:#666666;">
                                        <input type="checkbox" id="check" name="reg_yes" data="0" required
                                            style="pointer-events: visible;  position: relative; left: 0px; opacity: 1; float: left; margin-right: 10px;">

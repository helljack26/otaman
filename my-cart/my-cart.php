                        ...
                        <div class="order-info left single_order">
                            ...
                            <span id="fiz-osoba" style="display:block;">
                                <div class="personal_data">
                                    <h2 class="header_yellow" style="color:#5c6735;">Персональні дані</h2>
                                        ...
                                        <div class="person_switcher_container">
                                            <label class="label label-radio left clear">
                                                ...
                                                <span class="label-radio__icon left radio_fiz"
                                                    style="background:#fff;border:4px solid #5c6735"></span>
                            ...
                            <div class="order_item order-item-0">
                                <h2 class="header_yellow order_number" style="color:#5c6735;">
                                    Замовлення
                                </h2>
                                        ...
                                        <div class="delivery_target_block">
                                            ...
                                            <div
                                                ...
                                                <div class="order-row order-row__label switcher_row">
                                                        ...
                                                        <span class=" left"
                                                            ...
                                                            <label class="radiobox" id='1'>
                                                                <input class='box' type="radio" name="check" value="0"
                                                                    style="margin: 5px 6px 0 0; display: inline-block;" checked>
                                                    ...
                                                    <span style="font-size: 12px; width: 100%; display: inline-block; padding-left: 30px;">м.Бориспіль, вул.Запорізька,
                                                        10</span>
                                                        ...
                                                        <span class="left">
                                                            <label class="radiobox" id='2'>
                                                                <input class='box2' type="radio" name="check" value="0"
                                                                    style="margin: 8px 6px 0 0; display: inline-block; ">
                                                    ...
                                                    <label class="label label-radio left clear"
                                                        ...
                                                        <label class="radiobox" id='3'>
                                                            <input class='box3' type="radio" name="check" value="0"
                                                                style="margin: 2.5px 6px 0 0; display: inline-block;">
                                                            Кур'єром Отаман за адресою
                                                        </label>
                                                        <label>
                                                            2-3 дні
                                                        </label>
                                            ...
                                            <div class="payment_data_block">
                                                ...
                                                <div
                                                        ...
                                                        <span class="left">
                                                            <label class="radioboxs" data="1">
                                                                <input type="radio" id="pay2" name="pay" value="0"
                                                                    checked style="margin: 2.5px 6px 0 0; display: inline-block;" />
                                                    ...
                                                    <div class="payment_info">
                                                        ...
                                                        <span> UA943052990000026003020126395</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="pr_price_block left">
                                        ...
                                        <?
                                            ...
                                            foreach($_SESSION['cart'] as $id => $value){
                                                $id ;	 
                                                $ret=mysqli_query($conVikar,"SELECT * from products where organization='ТД ОТАМАН' and c_code='$value[pid]' and characteristic_uuid='$value[char_hash]'");
                                            ...
                                            <p>
                                                <label style="cursor:pointer;">
                                                    *Підтверджуючи замовлення я приймаю умови публічної
                                                    <a style="color:#5c6735; display: inline-block;" href="/page/oferta"
                                                        target="_blank">оферти</a>
                                                    та надаю згоду на
                                                    <a style="color:#5c6735; display: inline-block;" href="/page/personalDate"
